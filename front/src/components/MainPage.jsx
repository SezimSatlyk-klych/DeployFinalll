      ...
      <Box sx={{
        ...
        <Button
          ...
          sx={{
            ...
            borderRadius: 2,
            fontWeight: 700,
            color: page === 'ai_analysis' ? '#fff' : '#2563eb',
            background: page === 'ai_analysis' ? 'linear-gradient(90deg, #4f8cff 0%, #6fd6ff 100%)' : 'transparent',
            boxShadow: page === 'ai_analysis' ? '0 2px 12px 0 rgba(66,165,245,0.10)' : 'none',
            textTransform: 'none',
            width: '100%',
            justifyContent: 'flex-start',
            '&:hover': {
          ...
          onClick={() => setPage('ai_analysis')}
        >
          AI Анализ
        </Button>
      </Box>
      {/* Main content */}
      <Box sx={{ flex: 1, p: 6, width: '100%', maxWidth: '100%', overflow: 'visible' }}>
        {page === 'admin' && (
